...
namespace XiaoZhi.Net.Server.Providers.MCP.DeviceMcp
{
    ...
    internal class DeviceMcpClient : BaseMcpClient<DeviceMcpClient>, ISubMcpClient
    {
        ...
        public DeviceMcpClient(ILogger<DeviceMcpClient> logger, ToolRouter toolRegistry, McpServiceStore mcpServiceStore)
            : base(logger, toolRegistry, mcpServiceStore)
        {
        }
